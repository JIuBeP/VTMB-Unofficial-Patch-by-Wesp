...
def ch_shrekhub_patch():
    print "map patcher loaded"
    # some actions...
    if __main__.G.Zen_Visited == 1:
        windows = __main__.FindEntitiesByClass("func_breakable_surf")
        for window in windows:
            if window: window.Kill()
    __main__.G.Zen_Visited = 1
...
def ch_zhaos_1_patch():
    print "map patcher loaded"
    # some actions...
    if __main__.G.Glaze_Password == 1:
        windows = __main__.FindEntitiesByClass("func_breakable_surf")
        for window in windows:
            if window: window.Kill()
def hw_609_1_patch():
...
def hw_metalhead_1_patch():
    print "map patcher loaded"
    # some actions...
    if __main__.G.Metal_Visited == 1:
        windows = __main__.FindEntitiesByClass("func_breakable_surf")
        for window in windows:
            if window: window.Kill()
    __main__.G.Metal_Visited = 1
