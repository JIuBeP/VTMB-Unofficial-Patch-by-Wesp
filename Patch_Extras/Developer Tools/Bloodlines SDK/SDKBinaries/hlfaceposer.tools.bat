...
set FPConfigGen=assets\scripts\hlfaceposer_cfg.reg
set FPConfigVCD=assets\scripts\hlfaceposer_vcd.reg
set LipFormatHl2=assets\scripts\lips_hl2.lst
set LipFormatVtM=assets\scripts\lips_vtm.lst
set LipWavMeta=assets\scripts\wav_meta.bin
set SoX=assets\scripts\soxconverter\sox.exe
...
start %FPApp% -game assets -nop4 -novconfig -noshaderapi
