...
REG>nul ADD "HKCU\Software\Classes\LIPFile\shell\FacePoser\command" /f /ve /d "%CD%\hlfaceposer.tools.bat \"%%1\""
...
REG>nul ADD "HKCU\Software\Classes\VCDFile\shell\FacePoser\command" /f /ve /d "%CD%\hlfaceposer.tools.bat \"%%1\""
